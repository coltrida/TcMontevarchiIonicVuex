<template>
    <master-layout pageTitle="Prenotazione Particolare">
        <ion-list>
            <ion-list-header>
                <h2>Prenotazioni Particolari</h2> 
            </ion-list-header>
            <ion-item>
            ...
            <ion-item>
            <ion-button size='large' expand="full" @click="prenota()">Prenota</ion-button>
            </ion-item>
        </ion-list>
    </master-layout>
</template>
